...
while 1:
	...
	if k == 13:
		...
		# name = str(num) + '.jpeg'
		# cv2.imwrite('left/l' + name,roi_color[yl+1:yl-1 + eh,xl+1:xl-1 + ew])
		# cv2.imwrite('right/r' + name,roi_color[yr+1:yr-1 + eh,xr+1:xr-1 + ew])
		# cv2.imshow('img',roi_color[20:200])
		# num += 1
